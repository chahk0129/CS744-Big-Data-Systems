...
mkdir logs
echo -e "---------- Network Stat. -------------" >> logs/$1_namenode_stat.before
cat /proc/net/dev >> logs/$1_namenode_stat.before
echo -e "\n\n---------- Disk Stat. -------------" >> logs/$1_namenode_stat.before
cat /proc/diskstats >> logs/$1_namenode_stat.before

echo -e "---------- Network Stat. -------------" >> logs/$1_datanode1_stat.before
ssh node1 cat /proc/net/dev >> logs/$1_datanode1_stat.before
echo -e "\n\n---------- Disk Stat. -------------" >> logs/$1_datanode1_stat.before
ssh node1 cat /proc/diskstats >> logs/$1_datanode1_stat.before

echo -e "---------- Network Stat. -------------" >> logs/$1_datanode2_stat.before
ssh node2 cat /proc/net/dev >> logs/$1_datanode2_stat.before
echo -e "\n\n---------- Disk Stat. -------------" >> logs/$1_datanode2_stat.before
ssh node2 cat /proc/diskstats >> logs/$1_datanode2_stat.before
...
echo -e "---------- Network Stat. -------------" >> logs/$1_namenode_stat.after
cat /proc/net/dev >> logs/$1_namenode_stat.after
echo -e "\n\n---------- Disk Stat. -------------" >> logs/$1_namenode_stat.after
cat /proc/diskstats >> logs/$1_namenode_stat.after

echo -e "---------- Network Stat. -------------" >> logs/$1_datanode1_stat.after
ssh node1 cat /proc/net/dev >> logs/$1_datanode1_stat.after
echo -e "\n\n---------- Disk Stat. -------------" >> logs/$1_datanode1_stat.after
ssh node1 cat /proc/diskstats >> logs/$1_datanode1_stat.after

echo -e "---------- Network Stat. -------------" >> logs/$1_datanode2_stat.after
ssh node2 cat /proc/net/dev >> logs/$1_datanode2_stat.after
echo -e "\n\n---------- Disk Stat. -------------" >> logs/$1_datanode2_stat.after
ssh node2 cat /proc/diskstats >> logs/$1_datanode2_stat.after
